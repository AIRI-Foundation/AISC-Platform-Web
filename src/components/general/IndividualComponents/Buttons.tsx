...
"w-full mb-2 mt-1 rounded-[7px] border border-slate-300 bg-slate-50 px-2.5 py-2 text-sm text-slate-900 outline-none transition focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/25"  
